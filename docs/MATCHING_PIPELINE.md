...
This is the overview of the system. Every other doc in
...
**CRITICAL!!**
The dominant cost is step 7 (the LLM comunication forum). Everything else is
...
- The LLM only re-enters at step 7 (the communication forum), where it talks
